...
namespace ROIBackend.Controllers
{
    ...
    {
        private readonly ROI_HR_Management_DBContext _context;

        public DepartmentsController(ROI_HR_Management_DBContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Department>> PostDepartment(Department department)
        {
          if (_context.Departments == null)
          {
              return Problem("Entity set 'ROI_HR_Management_DBContext.Departments'  is null.");
          }
